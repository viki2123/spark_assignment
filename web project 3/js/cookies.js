function validate()
	{
		...
		{
			setCookie("prev_page","C:\Users\VIKITHA.H\Desktop\web project 3\html\personal_banking.html");
		}
...
function checkCookie()
{
	...
	if(user!="")
	{
		...
		if(prev_page=="C:\Users\VIKITHA.H\Desktop\web project 3\html\login.html")
		{
	...
	{
		window.location.assign("C:\Users\VIKITHA.H\Desktop\web project 3\html\login.html");
	}
}
var flag;
function deleteCookie(flag)
{
	...
	if(flag==1)
		...
		window.location.assign('C:\Users\VIKITHA.H\Desktop\web project 3\html\main.html');
}
...
function checkLogin(check)
{
	...
	if(user!="")
	{
		if(check==1)
		{
			window.location.assign("C:\Users\VIKITHA.H\Desktop\web project 3\html\personal_banking.html");
		}
		document.getElementById("welcome_user").innerHTML="Welcome, "+getCookie("name_user");
	}
}